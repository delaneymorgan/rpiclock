...
kMembers_Formats = dict(time='string', date='string', display='string', weather='string', brightness="integer",
						large_font="integer", small_font="integer", text_color='list', window_size='list',
...
class TimeWidget(Label):
	def __init__(self, myConfig, size_hint=(None, None)):
		...
		self.myConfig = myConfig
		self.font_size = myConfig.get()["formats"]["large_font"]
	...
	def update(self, dt):
		...
		timeStr = time.strftime(self.myConfig.get()["formats"]["time"], localTime)
...
class DateWidget(Label):
	def __init__(self, myConfig):
		...
		self.myConfig = myConfig
		self.font_size = myConfig.get()["formats"]["small_font"]
		self.color = myConfig.get()["formats"]["text_color"]
		self.lastDate = ""
		self.update(0)
		return
...
class WeatherWidget(BoxLayout):
	def __init__(self, myConfig, weatherMonitor):
		...
		self.tempNowLabel.font_size = self.myConfig.get()["formats"]["small_font"]
		self.tempMinMaxLabel = Label()
		self.tempMinMaxLabel.color = myConfig.get()["formats"]["text_color"]
		self.tempMinMaxLabel.font_size = self.myConfig.get()["formats"]["small_font"]
